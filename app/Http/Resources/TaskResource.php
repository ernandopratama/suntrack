...
class TaskResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'recurrence_time' => $this->recurrence_time ? substr((string) $this->recurrence_time, 0, 5) : null,
            ...
            'recurrence_max_occurrences' => $this->recurrence_max_occurrences,
            'recurrence_generated_count' => $this->recurrence_generated_count,
