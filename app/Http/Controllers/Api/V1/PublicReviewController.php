...
class PublicReviewController extends Controller
{
    ...
    public function show(Request $request, string $token)
    {
        ...
        if ($link->linkable_type === 'App\Models\Promotion') {
        ...
        $link->linkable->load($linkableRelations);

        return response()->json([
            'success' => true,
            'message' => 'Public review data retrieved successfully.',
            'data' => new PublicReviewResource($link->linkable),
        ]);
    }
    ...
    public function storeComment(StoreCommentRequest $request, string $token)
    {
        ...
        $comment = $link->linkable->comments()->create([
